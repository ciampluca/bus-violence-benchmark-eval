...
EXPS=(
    ...
    real-life-violence/resnet18-2plus1d-rgb-nopretr
    real-life-violence/resnet18-3d-rgb-nopretr
    real-life-violence/slowfast-rgb-nopretr
    real-life-violence/videoswintransformer-k400-rgb-nopretr
    ############################
    ...
    surveillance-camera-fight/resnet18-2plus1d-rgb-nopretr
    surveillance-camera-fight/resnet18-3d-rgb-nopretr
    surveillance-camera-fight/slowfast-rgb-nopretr
    surveillance-camera-fight/videoswintransformer-k400-rgb-nopretr
    ############################
    # RWF-2000
    ############################
    ...
    RWF-2000/resnet18-2plus1d-rgb-nopretr
    rRWF-2000/resnet18-3d-rgb-nopretr
    RWF-2000/slowfast-rgb-nopretr
    RWF-2000/videoswintransformer-k400-rgb-nopretr
)
